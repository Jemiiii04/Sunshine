...
<?php include 'include/conn.php' ?>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            <img src="<?php echo $img ?>" alt="Animated Image" class="children-img" data-aos="fade-up" data-aos-duration="1500">
        </div>
    </div>
  </div> 
  ...
  <div class="AU container">
    <div class="row">
      ...
      ?>
      <div class="col-md-6">
          <h1 class="AU1" data-aos="fade-right"><?php echo $title ?></h1>
          <h1 class="AU2" data-aos="fade-right"><?php echo $subtitle ?></h1>
          <p class="AU3" data-aos="fade-right">
            <?php echo $description ?>
          </p>
          <p class="AU3" data-aos="fade-right">
          ...
          <div class="col-lg-8">
            <div class="AU6 container text-center">
              ...
              ?>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center" data-aos="zoom-in" >
                    <div class="card shadow-lg border-0" style="width: 100%; max-width: 18rem;">
                        <img src="admin/pic/<?php echo $row["image1"] ?>" class="card-img-top img-fluid" alt="bootstrap">
                        <div class="card-body text-center">
                            <h5 class="card-text fw-bold"><?php echo $row["title1"] ?></h5>
                            <h6 class="AU5 card-subtitle text-body-secondary"><?php echo $row["subtitle"] ?></h6>
                        </div>
                    </div>
                </div>
              ...
              ?> 
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center" data-aos="zoom-in">
                  <div class="card shadow-lg border-0" style="width: 100%; max-width: 18rem;">
                      ...
                      <div class="card-body text-center">
                          <h5 class="card-text fw-bold"><?php echo $row["title1"] ?></h5>
                          <h6 class="card-subtitle text-body-secondary"><?php echo $row["subtitle"] ?></h6>
                      </div>
                  </div>
                </div>
        ...
        <div class="AU10 col-md-4">
          <div class="container-fluid">
            <div class="row align-items-center">
              <div class="col-md-2" style="margin-right: 10px;"   data-aos="zoom-in">
