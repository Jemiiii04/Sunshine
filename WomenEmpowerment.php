...
<?php include 'include/conn.php' ?>
    ...
    <section class="EW-section">
        <div class="overlay-service"></div>
            <div class="service">
                <h1 class="ser1"  data-aos="zoom-in">WOMEN EMPOWERMENT</h1>
            </div>
      </section><br>
 ...
 <div class="container-fluid mission-section">
    ...
    <img id="animatedImage" src="Images/service/EW1.png" alt="Mission Chart" class="w-50">
</div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12 community-image">
        <img src="Images/service/EW2.jpg" alt="Animated Image" class="children-img" data-aos="zoom-in" data-aos-duration="1500">
      </div>
    </div>
  </div>
