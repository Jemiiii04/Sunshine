...
<?php include 'include/conn.php'?>
  ...
  <section class="edu-section">
    ...
    <div class="service">
        <h1 class="ser1"data-aos="zoom-in">EDUCATION IS IMPORTANT</h1>
    </div>
  </section><br>
    ...
    <div class="EDU2 p-4" >
        ...
        <div class="container">
            ...
            <img src="Images\service\program.webp" alt="Animated Image" class="children-img" data-aos="zoom-in" data-aos-duration="1500">
        </div>
    </div><br>
