        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-8">
                ...
                <?php if ($edit): ?>
                    ...
                    <div class="card">
                        <div class="card-header bg-primary text-white">Edit Consult Us</div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <button class="cancelbtn"><a href="ConsultUs.php" style="text-decoration: none;"><span>Cancel</span></a></button>
                            </form>
                        </div>
                    </div>
                <?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <?php
                                $sql = "SELECT id, name, email, phone_no, typeofconsultation, message FROM consultus";
