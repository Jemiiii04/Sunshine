...
include 'include/conn.php'; 
    ...
    $id = $full_name = $phone_no = $email = $message = "";
    $edit = false; 
    ...
    if (isset($_POST['edit'])) {
        ...
        if (isset($_POST['update'])) {
            ...
            $sql = "UPDATE contactus SET full_name='$full_name', email='$email', message='$message', phone_no='$phone_no' WHERE id=$id";
            $conn->query($sql);

            if ($conn->query($sql) === TRUE) {
                header("Location: ContactUs.php"); // Redirect to avoid form resubmission
                exit;
            } else {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-8">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <h1 class="title mb-4"><u><?php echo $edit ? "Edit Contact Us" : "Contact Us"; ?></u></h1>
                    </div>
                </div>
                ...
                <?php if ($edit): ?>
                    ...
                    <div class="card">
                        <div class="card-header bg-primary text-white">Edit Contact Us</div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <button class="cancelbtn"><a href="ContactUs.php" style="text-decoration: none;"><span>Cancel</span></a></button>
                            </form>
                        </div>
                    </div>
                <?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <?php
                                $sql = "SELECT id, full_name, email, phone_no, message FROM contactus";
