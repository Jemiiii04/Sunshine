...
$edit = false;
    ...
    if (isset($_POST['update'])) {
        ...
        if ($conn->query($sql) === TRUE) {
            header("Location: Blog-table.php"); // Redirect to avoid form resubmission
            exit;
        } else {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-8">
                <div class="row mt-2">
                    <div class="col-md-12">
                        <h1 class="title mb-4"><u><?php echo $edit ? "Edit Blogs" : "Blogs"; ?></u></h1>
                    </div>
                </div>

                <div class="row p-4">
                    <div class="col-md-12">
                        <button class="mybtn"><a href="Blog-form.php" style="text-decoration: none; float: right;"><span>Add New</span></a></button>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Date</label>
                                    <textarea name="date1" class="form-control" required><?php echo $date1; ?></textarea>
                                </div>

                                <button type="submit" name="update" class="mybtnn"><span>Update</span></button>
                                <button class="cancelbtn"><a href="Blog-table.php" style="text-decoration: none;"><span>Cancel</span></a></button>
                            </form>
                        </div>
                    </div>
                <?php else: ?>
