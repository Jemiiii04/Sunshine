...
$fileName = '';
    ...
    $sql = "INSERT INTO blog(image1, title1, description1, date1) 
            VALUES ('$fileName', '$title1', '$description1', '$date1')";
...
<div class="wrapper">
    ...
    <h1 class="title mb-4"><u>Blog form</u></h1>
        <div class="card">
            <div class="card-body">
                <form action="blogform.php" method="POST" enctype="multipart/form-data">

                    <!-- Card Image-1 -->
                    <h2 class="text-center mb-4">blog images</h2>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="date1" id="date1" rows="2" placeholder="Enter date"></textarea>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="Submit" class="mybtnn"><span>Submit</span></button>
                    </div>
                </form>
            </div>
        </div>
