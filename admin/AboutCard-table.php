    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-8">
                ...
                <div class="row p-4">
                    <div class="col-md-12">
                        <button class="mybtn"><a href="AboutCard-form.php" style="text-decoration: none; float: right;"><span>Add New</span></a></button>
                    </div>
                </div>
                ...
                <?php if ($edit): ?>
                    ...
                    <div class="card">
                        <div class="card-header bg-primary text-white">Edit About us - Card</div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <button class="cancelbtn"><a href="AboutCard-table.php" style="text-decoration: none;"><span>Cancel</span></a></button>
                            </form>
                        </div>
                    </div>
                <?php else: ?>
